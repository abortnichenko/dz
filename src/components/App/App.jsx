   ...
   return (
      <Fragment>
        <header id="main-header">
          <div className="main-title">Личный кабинет руководителя банковского отдела</div>
          <div id="owner-name">
            Бортниченко Анастасия Игоревна
          </div>
        </header>
...
const mapDispatchToProps = dispatch => ({ 
  ...
  downloadManagersDispatch: (managers) => dispatch(downloadManagersAction(managers))
});
